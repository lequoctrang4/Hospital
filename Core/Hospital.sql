...
(
    ...
    CONSTRAINT fk_treat_Patient FOREIGN KEY (Patient_ID) REFERENCES PATIENT(Patient_ID) ON DELETE SET NULL,
    CONSTRAINT fk_treat_S_ID FOREIGN KEY (S_ID) REFERENCES DOCTOR(S_ID) ON DELETE SET NULL
);
